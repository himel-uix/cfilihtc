        ...
        >
            ...
            >
                ...
                <div>
                    ...
                    <p className="font-normal text-sm md:text-sm lg:text-base text-[#F8FAFC]">আমাদের ওয়েবসাইট ও সেবা ব্যবহার করার জন্য আপনাকে ধন্যবাদ।</p>
                </div>
                <ul>
                    <li>★আমাদের সরবরাহকৃত সকল পণ্য স্বাস্থ্য সচেতনতা বৃদ্ধির উদ্দেশ্যে প্রস্তুত ও সরবরাহ করা হয়।</li>
                    <li>★অর্ডার নিশ্চিত হওয়ার পর নির্ধারিত সময়ের মধ্যে ডেলিভারি সম্পন্ন করা হবে। তবে প্রাকৃতিক দুর্যোগ, রাজনৈতিক পরিস্থিতি বা অনিবার্য কারণে ডেলিভারিতে বিলম্ব হতে</li>
                    <li>★ওয়েবসাইটের কোনো তথ্য, ছবি বা কনটেন্ট কর্তৃপক্ষের লিখিত অনুমতি ছাড়া কপি, ডাউনলোড বা বাণিজ্যিক কাজে ব্যবহার করা সম্পূর্ণ নিষিদ্ধ।</li>
                    <li>★ভুয়া অর্ডার, প্রতারণামূলক কার্যক্রম বা অপব্যবহার শনাক্ত হলে কর্তৃপক্ষ অর্ডার বাতিল এবং প্রয়োজনীয় আইনগত ব্যবস্থা গ্রহণের অধিকার সংরক্ষণ করে।</li>
                </ul>
            </div>
        </div>
    );
